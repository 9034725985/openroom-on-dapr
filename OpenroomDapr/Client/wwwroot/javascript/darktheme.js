export function onDisplayModeChanged(mode) {
    var lightElement = document.getElementById('default-theme');
    var darkElement = document.getElementById('sonar-dark-theme');
...
window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', function (event) {
    ...
    console.info({ newColorScheme: newColorScheme });
});
